...
[assembly: OwinStartup(typeof(SimOnline.Web.App_Start.Startup))]
...
namespace SimOnline.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(SimOnlineDbContext.Create);
        ...
        public class AuthorizationServerProvider : OAuthAuthorizationServerProvider
        {
            ...
            public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
            {
                ...
                if (user != null)
                {
                    ...
                    //identity.AddClaim(new Claim("AgentID", user.AgentID));
        ...
        {
            var userStore = new UserStore<AppUser>(context.Get<SimOnlineDbContext>());
