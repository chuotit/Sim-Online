(function (app) {
    ...
    appGroupListController.$inject = ['$scope', 'apiService', 'notificationService','$filter'];

    function appGroupListController($scope, apiService, notificationService, $filter) {
        $scope.loading = true;
        $scope.data = [];
        $scope.page = 0;
        $scope.pageCount = 0;
        ...
        function search(page) {
            ...
            apiService.get('api/appGroup/getlistpaging', config, dataLoadCompleted, dataLoadFailed);
        }
